...
Charmin: function(affected, editor){
  $('#testSuite').append('<iframe width="560" height="315" src="https://www.youtube.com/embed/JAzqGuZfo00?autoplay=1&rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>');
