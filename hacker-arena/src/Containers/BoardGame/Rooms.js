  ...
  return <div>
    {
      props.rooms.map((room,i)=> {
        ...
        for (let j = 0; j < playerNames.length; j++) {
          playerSpans.push(
            <li className='list-group-item' style={{ textAlign: 'left'}} key={(playerNames[j] || "OPEN") + j}>
              <h4>
        ...
        return  <div key={i} className='list-group-item' style={{ color: 'black', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1)', margin: '1%', marginLeft: '20%', marginRight: '20%'}}>
