  ...
  return <div>
    {
      props.rooms.map((room,i)=> {
        ...
        return  <div className='list-group-item' style={{ color: 'black', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.1), 0 6px 20px 0 rgba(0, 0, 0, 0.1)', margin: '1%', marginLeft: '20%', marginRight: '20%'}}>
